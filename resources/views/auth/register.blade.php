        ...
        <div class="w-6/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{route('register')}}" method="post" >
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Your password" class="bg-gray-100 border-2 w-full p-4 rounded-lg " value="">
                </div>
                <button type="submit" class="bg-blue-500 hover:bg-blue-400 border-b-4 border-blue-700 rounded text-white px-4 py-3 w-full font-bold">Register</button>
            </form>
        </div>
    </div>
@endsection